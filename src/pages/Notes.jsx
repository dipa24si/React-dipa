  ...
  return (
    <div className="max-w-2xl mx-auto p-6">
      ...
      <div className="bg-white rounded-2xl shadow-lg p-6">
        ...
        {success && (
          <div className="mb-4 p-3 bg-emerald-100 text-emerald-800 rounded-xl">
            {success}
          </div>
        )}
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <textarea
            ...
            rows="2"
            disabled={loading}
            className="w-full p-3 bg-gray-50 rounded-2xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all duration-200 resize-none disabled:opacity-50"
          />
